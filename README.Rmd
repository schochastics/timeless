...
[![Codecov test coverage](https://codecov.io/gh/schochastics/chronos/branch/main/graph/badge.svg)](https://app.codecov.io/gh/schochastics/chronos?branch=main)
<!-- badges: end -->

A fast general purpose date/time converter written in Rust with crates [dateparser](https://crates.io/crates/dateparser) and [chrono](https://crates.io/crates/chrono).
...
It does not recognize all accepted formats of chronos out of the box. (Note that the unrecognized formats can be added via `anytime::addFormats()`)
```{r}
dplyr::coalesce(
...
See [this benchmark](https://github.com/schochastics/chronos/blob/main/data-raw/benchmark.md) for more details.
