...
#> [28] "2021-02-21 08:59:57" "2021-02-21 08:59:57" "2021-02-21 08:59:57"
#> [31] "2020-07-20 08:59:57" "2024-02-24 00:06:06" "2024-02-24 15:00:00"
...
#> [46] "2021-05-26 07:49:00" "2012-09-17 18:09:00" "2021-02-21 08:59:57"
#> [49] "2021-05-25 07:59:57" "1970-10-07 08:59:57" "1970-10-07 08:59:57"
#> [52] "1970-10-07 08:59:57" "1970-10-07 08:59:57" "1970-10-07 08:59:57"
#> [55] "2006-02-12 18:17:00" "2006-02-12 18:17:00" "2019-05-14 17:11:40"
#> [58] "1970-10-07 08:59:57" "1970-10-07 08:59:57" "2013-02-03 08:59:57"
#> [61] "2013-07-01 07:59:57" "2014-04-08 20:05:00" "2014-04-08 20:05:00"
...
#> [73] "2012-03-19 09:11:59" "2014-03-31 07:59:57" "2014-03-31 07:59:57"
#> [76] "1971-08-21 08:59:57" "1971-08-01 08:59:57" "2014-04-08 20:05:00"
#> [79] "2014-04-08 20:05:00" "2014-04-02 01:00:51" "2014-04-02 01:00:51"
#> [82] "2012-03-19 09:11:59" "2012-03-19 09:11:59" "2014-03-31 07:59:57"
#> [85] "2014-03-31 07:59:57" "2014-03-31 07:59:57" "2014-03-31 07:59:57"
#> [88] "1971-08-21 08:59:57" "2014-03-30 07:59:57" "2014-03-24 08:59:57"
#> [91] "2017-11-13 13:14:20" "2014-04-08 09:25:18" "2014-04-08 07:59:57"
```
...
#> [13] "%Y-%b-%d %H:%M:%S%f"        "%Y-%b-%e %H:%M:%S%f"       
#> [15] "%Y/%b/%d %H:%M:%S%f"        "%Y/%b/%e %H:%M:%S%f"       
#> [17] "%Y%b%d %H%M%S%F"            "%Y%b%e %H%M%S%F"           
#> [19] "%Y%b%d %H:%M:%S%F"          "%Y%b%e %H:%M:%S%F"         
#> [21] "%b/%d/%Y %H:%M:%S%f"        "%b/%e/%Y %H:%M:%S%f"       
#> [23] "%b-%d-%Y %H:%M:%S%f"        "%b-%e-%Y %H:%M:%S%f"       
#> [25] "%d.%b.%Y %H:%M:%S%f"        "%e.%b.%Y %H:%M:%S%f"       
#> [27] "%d%b%Y %H%M%S%f"            "%e%b%Y %H%M%S%f"           
#> [29] "%d%b%Y %H:%M:%S%f"          "%e%b%Y %H:%M:%S%f"         
#> [31] "%d-%b-%Y %H%M%S%f"          "%e-%b-%Y %H%M%S%f"         
#> [33] "%d-%b-%Y %H:%M:%S%f"        "%d-%b-%Y %H:%M:%S%f"       
#> [35] "%Y-%B-%d %H:%M:%S%f"        "%Y-%B-%e %H:%M:%S%f"       
#> [37] "%Y/%B/%d %H:%M:%S%f"        "%Y/%B/%e %H:%M:%S%f"       
#> [39] "%Y%B%d %H%M%S%f"            "%Y%B%e %H%M%S%f"           
#> [41] "%Y%B%d %H:%M:%S%f"          "%Y%B%e %H:%M:%S%f"         
#> [43] "%B/%d/%Y %H:%M:%S%f"        "%B/%e/%Y %H:%M:%S%f"       
#> [45] "%B-%d-%Y %H:%M:%S%f"        "%B-%e-%Y %H:%M:%S%f"       
#> [47] "%d.%B.%Y %H:%M:%S%f"        "%e.%B.%Y %H:%M:%S%f"       
#> [49] "%a %b %d %H:%M:%S%F %Y"     "%a %b %e %H:%M:%S%F %Y"    
#> [51] "%a %d %b %Y %H:%M:%S%F"     "%a %e %b %Y %H:%M:%S%F"    
#> [53] "%Y-%m-%d %H:%M:%S%Z"        "%Y-%m-%e %H:%M:%S%Z"       
#> [55] "%a %b %d %H:%M:%S%F xxx %Y" "%a %b %e %H:%M:%S%F xxx %Y"
#> [57] "%Y-%m-%d"                   "%Y-%m-%e"                  
#> [59] "%Y%m%d"                     "%m/%d/%Y"                  
#> [61] "%m/%e/%Y"                   "%m-%d-%Y"                  
#> [63] "%m-%e-%Y"                   "%Y-%b-%d"                  
...
#>           chronos(bench_date)   206.798   239.208   337.84   326.983   379.519
#>  anytime::anytime(bench_date) 30486.289 35239.443 40006.66 38352.382 43952.069
#>       max neval
#>   1118.51   100
#>  74684.47   100
```
